...
- Business logic TIDAK boleh ada di controllers/routes/handlers
- Data access HANYA melalui repository/service layer
- UI components TIDAK boleh melakukan data fetching langsung (kecuali server components)
